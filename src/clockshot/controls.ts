...
export class Controls {
  ...
  private grappleLabel!: Phaser.GameObjects.Text;
  ...
  constructor(
    ...
    this.grappleLabel = scene.add
      .text(0, 0, 'GRAPPLE', { fontFamily: FONT, fontSize: '10px', color: hex(C.cyan) })
      .setOrigin(0.5)
      .setScrollFactor(0)
      .setDepth(901);
  ...
  layout(L: Layout): void {
    ...
    this.grappleLabel
      .setPosition(this.grappleX, this.grappleY + this.grappleR + 11 * ui)
      .setFontSize(Math.round(9.5 * ui));
  ...
  private drawGrapple(): void {
    ...
    this.drawHook(g, x, y, r * 0.46, on ? 1 : lit ? 0.95 : 0.5);
    this.grappleLabel.setAlpha(on ? 1 : lit ? 0.9 : 0.5);
  }
  ...
  objects(): Phaser.GameObjects.GameObject[] {
    return [this.stickGfx, this.grappleGfx, this.grappleLabel];
  }

  setVisible(visible: boolean): void {
    this.stickGfx.setVisible(visible);
    this.grappleGfx.setVisible(visible);
    this.grappleLabel.setVisible(visible);
  }
